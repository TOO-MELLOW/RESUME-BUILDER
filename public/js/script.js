...
// ----------------------------------------------------------------------------
//  The rest of the file (renderModern, renderAts, renderExecutive, etc.)
//  already use SR directly and will now automatically benefit from the headingClass
//  parameter, but they don't pass a custom class so they keep the default.
//  They also never stripped labels, so they are safe.
// ----------------------------------------------------------------------------

// All other renderers (modern, ats, executive, creative, split, timeline)
// remain unchanged because they rely solely on SR with default labels.
// No changes needed.

// ============================================================================
//  End of file – everything else below (AI functions, import/export, UI, etc.)
//  remains exactly as it was, except that the call to enforceSectionCoverage
//  has been removed and replaced with validateSectionCoverage.
// ============================================================================
