...
// Mirrors TEMPLATE_ID_MIGRATIONS in public/js/template-system.js. These ids
// used to be separate gallery entries that rendered through the exact same
// function as their "to" target, differing only by accent color. They were
// removed from the catalog above; any resume saved with one of these ids
// (React engine path) should resolve to the surviving id and keep the
// original color as a theme override rather than silently losing its style.
export const TEMPLATE_ID_MIGRATIONS = {
